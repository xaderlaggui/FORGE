...
import { InteractivePhotoCard } from '../../features/progress/components/InteractivePhotoCard';
import { StickerShareModal } from '../../features/progress/components/InteractivePhotoCard/StickerShareModal';
import { OffScreenStickerTemplate } from '../../features/progress/components/InteractivePhotoCard/OffScreenStickerTemplate';
import { useWorkoutDetail } from '../../features/workout/hooks/useWorkoutDetail';
...
const useStyles = (T: any) => StyleSheet.create({
  ...
  borderedBackBtn: {
    ...
    backgroundColor: T.colors.bg1 + 'CC',
